  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index_crud.php">Catálogo</a>
        </li>
        <li class="nav-item">
...
<div class="contenedor">
  ...
  <form class="form_listado" method="post" action="insert.php">
  ...
  <!--Footer -->
  <footer>
  <div class="card-group text-center footer-style mt-3 bg-dark">
