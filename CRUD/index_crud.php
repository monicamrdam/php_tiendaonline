...
<div class="contenedor  py-5 ml-5">
  ...
  <?php
    ...
    while ($reg=$registros->fetch_array())
    {
      ...
      echo '</td>';
      echo '<td class ="tdlistado">';
      echo '<a class="bt-listado" href="delete.php?id='.$reg['discoId'].'">Borrar</a>';
      echo '</td>';
      echo '<td class ="tdlistado">';
      echo '<a class="bt-listado" href="formUpdate.php?id='.$reg['discoId'].'">Modificar</a>';
      echo '</td>';      
      echo '</tr>';      
    }    
    echo '<tr class ="trlistado"><td colspan="8">';
    echo '<a class="bt-listado" href="formInsert.php">Agrega un nuevo artículo</a>';
    echo '</td></tr>';
    echo '<table class="tablalistado">';    
